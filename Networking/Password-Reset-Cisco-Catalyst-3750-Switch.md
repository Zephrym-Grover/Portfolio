...
the switch to recover from a lost password by interrupting the boot process during power on and by entering a new password. These recovery procedures require physical access to the switch. (Taken directly from Cisco 3750 Config File)
